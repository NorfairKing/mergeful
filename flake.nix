{
  ...
  outputs =
    ...
    in
    {
      ...
      packages.${system} = haskellPackages.mergefulPackages;
      checks.${system} =
        let
          backwardCompatibilityCheckFor = nixpkgs: (haskellPackagesFor nixpkgs).mergefulRelease;
          allNixpkgs = {
            inherit
              nixpkgs-23_11;
          };
        ...
        backwardCompatibilityChecks // {
          forwardCompatibility = horizonPkgs.mergefulRelease;
          release = haskellPackages.mergefulRelease;
      ...
      devShells.${system}.default = haskellPackages.shellFor {
        name = "mergeful-shell";
        packages = p: builtins.attrValues p.mergefulPackages;
        withHoogle = true;
        doBenchmark = true;
